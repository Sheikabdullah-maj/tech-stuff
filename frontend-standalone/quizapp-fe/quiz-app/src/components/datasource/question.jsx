export default [
    {
      ...
      value : 'A library to build user interfaces with help of declarative code.',
    },
    {
      id: 'q2',
      ...
      value: 'Enabling the use of state and other React features in functional components.',
    },
    {
      id: 'q3',
      ...
      value: 'A JavaScript extension that adds HTML-like syntax to JavaScript.',
    },
    {
      id: 'q4',
      ...
      value:  'By defining a JavaScript function that returns a renderable value.',
    },
    {
      id: 'q5',
      ...
      value : 'An object in a component that holds values and may cause the component to render on change.',
    },
    {
      id: 'q6',
      ...
      value : 'By using the map() method to iterate over an array of data and returning JSX.',
    },
    {
      id: 'q7',
      ...
      value: 'Using an if-else statement.'
    },
  ];